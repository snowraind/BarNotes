...
struct AppTheme: Equatable {
    ...
    static let light = AppTheme(
        ...
        toolbarBackground: NSColor(calibratedRed: 0.86, green: 0.86, blue: 0.835, alpha: 1),
        rowBackground: NSColor.black.withAlphaComponent(0.065),
        separator: NSColor.black.withAlphaComponent(0.13),
        stroke: NSColor.black.withAlphaComponent(0.14),
